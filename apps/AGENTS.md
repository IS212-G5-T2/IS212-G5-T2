...
- The current frontend uses React, Vite, TypeScript, Tailwind CSS, React Router, Zustand, and npm. Verify current files and Jira requirements before changing these conventions.
...
- Read [frontend-specific guidance](frontend/AGENTS.md) before changing the current frontend application.
